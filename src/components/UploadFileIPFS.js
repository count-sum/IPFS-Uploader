...
class UploadFileIPFS extends Component {
    ...
    constructor(props, context) {
        ...
        this.FileContractAddress = this.drizzle.contracts.FileContract.address
        this.state = {
             ipfsHash: null,
             buffer:'',
             ethAddress:'',
    ...
    onSubmit = async (event) => {
        ...
        await ipfs.add(this.state.buffer, (err, ipfsHash) => {
            ...
            this.drizzle.contracts.FileContract.methods.addFile(this.state.ipfsHash,ipfsFileName,ipfsTags).send({
                from: this.account
            })
    ...
    render() {
        ...
        return(
            <div class="container">
                {/*IPFS PAGE*/}
                <span>
                <strong> Uploading a file will result in interacting with the contract: &nbsp;
                <EthAddress
                   address = {this.FileContractAddress}
                ...
                <form onSubmit={this.onSubmit}>
                    <div className="field">
                        ...
                        <input className={fileClasses} type="text" placeholder="Name your file" name="filename"
                        ...
                        {  this.state.fileNameValid === true
                            ?
                                <p className="help is-success fas fa-check">File name ok!</p>
                            :
                                <p className="help is-danger fas fa-exclamation-triangle"> Please insert the name of your file  (IPFS will store it as a hash)</p>
                        }
                    </div>
                    <div className="field">
                        <label className="label">Tags (sepparated by ",")</label>
                        <div className="control has-icons-left has-icons-right">
                        ...
                        {  this.state.tagsValid === true
                            ...
                            :
                                <p className="help is-danger fas fa-exclamation-triangle"> Separate tags with comas.</p>
                        }
                    </div>
                    ...
                    <div className="file">
                        ...
                        <span className="file-cta">
                            ...
                            Choose a file, add it's filename…    
                ...
                { this.state.imageUploading &&
                    <article class="message is-success">
                      ...
                      <div class="message-body">
                        <br />
                        <i className="fas fa-compact-disc fa-3x fa-pulse"></i>
                      </div>
                    </article>
                }
